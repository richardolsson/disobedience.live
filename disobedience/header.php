...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri();?>/main.css?v=1708171447">
        ...
        <script src="<?php echo get_template_directory_uri();?>/main.js?v=1708171447"></script>
    </head>
    <body <?php body_class();?>>
